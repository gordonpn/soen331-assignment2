...
transition('merging lane', 'merging lane', 'after 1 second', 'Signal == change left lane', 'change left lane signal').
...
transition('merging lane', 'merging lane', 'after 1 second').
transition('merging lane', 'merging lane', 'after 1 second').
transition('merging lane', 'merging lane', 'after 1 second').
transition('merging lane', 'merging lane', 'after 1 second').
transition('merging lane', 'merging lane', 'after 1 second').
